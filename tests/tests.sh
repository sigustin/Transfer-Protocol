...
echo "Cleanup"
rm -f received.txt stderrReceiver.txt stderrSender.txt link.log received.gif
...
../receiver :: 1025 -f received.txt 2> stderrReceiver.txt &
../sender ::1 1025 -f file.txt 2> stderrSender.txt
...
link_pid=$!
../receiver :: 1026 -f received.txt 2> stderrReceiver.txt &
../sender ::1 1025 -f file.txt 2> stderrSender.txt
...
echo "Test #8 : transfer of bigImage.gif -> received.gif with bad network in both directions (jitter 0.5 seconds, loss rate 1% and error rate 1%)"
../link_sim -p 1025 -P 1026 -R -j 500 -l 1 -e 1 &> link.log &
link_pid=$!
../receiver :: 1026 -f received.gif 2> stderrReceiver.txt &
../sender ::1 1025 -f bigImage.gif 2> stderrSender.txt
